...
function workspaceScoped(slug: string) {
  ...
  return {
    ...
    teams: () => `${ws}/teams`,
    teamDetail: (keyOrId: string) => `${ws}/teams/${encode(keyOrId)}`,
    teamCycles: (keyOrId: string) => `${ws}/teams/${encode(keyOrId)}/cycles`,
    teamCycleDetail: (keyOrId: string, cycleNumber: number | string) =>
      `${ws}/teams/${encode(keyOrId)}/cycles/${encode(String(cycleNumber))}`,
    teamSettings: (keyOrId: string) => `${ws}/teams/${encode(keyOrId)}/settings`,
    cycles: () => `${ws}/cycles`,
    cycleDetail: (id: string) => `${ws}/cycles/${encode(id)}`,
    views: () => `${ws}/views`,
    viewDetail: (id: string) => `${ws}/views/${encode(id)}`,
    squads: () => `${ws}/squads`,
